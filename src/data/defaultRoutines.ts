...
const entries: Array<[string, string, string, Period, string]> = [
  ['07:00', '07:30', 'Acordar, higiene e beber água', 'morning', 'sunrise'],
  ['07:30', '08:30', 'Alimentar os animais com sua esposa', 'morning', 'paw'],
  ...
  ['13:00', '14:00', 'Almoço e tempo com sua esposa', 'afternoon', 'utensils'],
  ...
  ['17:45', '18:05', 'Fechar os animais com sua esposa', 'afternoon', 'paw'],
  ...
  ['20:15', '20:45', 'Preparar o jantar com sua esposa', 'night', 'cooking-pot'],
...
const claudio: RoutineTask[] = entries.map(([startTime, endTime, title, period, icon], order) => ({
  id: `claudio-${order + 1}`, person: 'claudio', title, startTime, endTime, period, icon, order
}));

export const defaultRoutines: Routines = { claudio, malu: [] };
